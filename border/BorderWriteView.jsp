...
<body>
	...
	<section class="section-img">
		...
		<div>
			<h1 class="tlt">글 작성하기</h1>
		</div>
		<div style="height: 100px;"></div>
	</section>
	<main class="notice" style="height: 800px; margin-top: 80px;">
		<div class="page-title"></div>
		<form class="write01" action="<c:url value="/BorderWriteDo"/>"
			method="post">
			<div class="contencen">
				<input type="text" placeholder="제목을 입력해주세요." name="boardTitle"
					required />
			 	<input type="text" placeholder="내용을 입력해주세요."
					name="boardContent" class="text" required />
				<div
					style="display: flex; justify-content: center; align-items: center;">
					<button type="submit" class="writeborder">글쓰기</button>
					<button class="writeborder"
						onclick="location.href='${pageContext.request.contextPath}/borderView'">취소</button>
				</div>
			</div>
		</form>
	</main>
